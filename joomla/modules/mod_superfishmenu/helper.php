...
class superfish_modMainMenuHelper extends modMainMenuHelper {
...
//					die($url);
			...
			if($params->get('menuWidthMod_enable')) {
				...
				$superstring .= ".superfish_width_mod({ vertical:$vertical, menuWidth:'$menuWidth', equalWidth:$equalWidth, resizeSeps:$resizeSeps, resizeSubMenus:$resizeSubMenus })";
			}
