...
<input type="hidden" name="task" value="popup_listadd" />
<input type="hidden" name="ptask" value="popup_listadd" />
<input type="hidden" name="listid" value="<?php echo (int)$this->listid; ?>" />
