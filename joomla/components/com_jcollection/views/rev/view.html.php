...
class JCollectionViewRev extends JView
{
	function display($tpl = null)
	{
		...
		if($review->id) {
			...
			$link = JRoute::_( 'index.php?option=com_jcollection&view=item&id='.$review->slug );
		...
		$doc->setTitle( $oldtitle.' - '.htmlspecialchars( $review->name ) );
		...
		$lists['image'] = JHTML::_( 'list.images',  'img', $review->img, $js, '/images/jcollection/' );
		...
		$this->assignRef( 'revparams', $revparams );
