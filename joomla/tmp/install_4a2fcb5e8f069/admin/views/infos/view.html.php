...
class JCollectionViewInfos extends JView
{
	...
	**/
	function display($tpl = null)
	{
		...
		$lists['item'] = JCollectionHelper::filterItem( 'filter_item', intval($filter_item), intval($filter_catid), intval($filter_subcats) );

		$this->assignRef('filter_item', $filter_item);
