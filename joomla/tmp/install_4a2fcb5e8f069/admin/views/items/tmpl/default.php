...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th><?php echo JHTML::_('grid.sort',  'Category', 'category', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
			...
			<th width="5%" nowrap="nowrap"><?php echo JHTML::_('grid.sort',  'Access', 'i.access', $this->lists['order_Dir'], $this->lists['order'] ); ?>
			</th>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		$link = JRoute::_( 'index.php?option='.$option.'&controller=item&view=item&task=edit&cid[]='.$row->id );
		$cat_link  = JRoute::_( 'index.php?option='.$option.'&controller=category&view=category&task=edit&cid[]='. $row->catid );
		?>
	<tr class="<?php echo "row$k"; ?>">
		...
		if (  JTable::isCheckedOut($this->user->get ('id'), $row->checked_out ) ) {
			...
			title="<?php echo JText::_( 'Edit Item' );?>::<?php echo $row->name; ?>"><a
			href="<?php echo $link; ?>"><?php echo $row->name; ?></a></span> <?php } ?>
		</td>
		<td><span class="editlinktip hasTip"
			title="<?php echo JText::_( 'Edit Category' );?>::<?php echo $row->category; ?>"><a
			href="<?php echo $cat_link; ?>"><?php echo $row->category; ?></a><span></td>
