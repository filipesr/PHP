<?php
/**
 * JCollection Wikipediaitem element (for usage in parameter panels)
 *
 * @version $Id$
 * @package JCollection
...
class JElementWikipediaitem extends JElement
{
	/**
	* Element name
	*
	...
	*/
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if($value) {
			...
			$item->name = JText::_('Find Wikipedia entry');
		}
		...
		$link = 'index.php?option='._JC_COMPNAME.'&amp;controller=elements&amp;task=wikipediaitem&amp;tmpl=component&amp;object='.$name;
