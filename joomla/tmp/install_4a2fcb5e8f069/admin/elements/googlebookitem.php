<?php
/**
 * JCollection Googlebookitem element (for usage in parameter panels)
 *
 * @version $Id$
 * @package JCollection
...
class JElementGooglebookitem extends JElement
{
	/**
	* Element name
	*
	...
	*/
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if($value) {
			...
			$item->name = JText::_('Find google book id');
		}
		...
		$link = 'index.php?option='._JC_COMPNAME.'&amp;controller=elements&amp;task=googlebookitem&amp;tmpl=component&amp;object='.$name;
		...
		$html .= '<div class="button2-left"><div class="blank"><span onclick="jSelectItem(\'\',\''.JText::_('Find google book id').'\',\''.$name.'\');" title="'.JText::_('Clear selection').'">'.JText::_('Clear').'</span></div></div>'."\n";
