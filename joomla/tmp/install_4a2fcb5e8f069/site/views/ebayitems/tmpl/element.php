...
<table>
	<tr>
		<td align="left" width="100%"><?php echo JText::_( 'Filter' ); ?>: <input
			type="text" name="search_wse" id="search_wse"
			value="<?php echo $this->lists['search'];?>"
			onchange="document.adminForm.submit();" />
		<button onclick="this.form.submit();"><?php echo JText::_( 'Go' ); ?></button>
		<button
			onclick="document.getElementById('search_wsw').value='';this.form.submit();"><?php echo JText::_( 'Reset' ); ?></button>
		</td>
...
<input type="hidden" name="task" value="ebayitem" />
