<?php
/**
 * JCollection Isbndbitem element (for usage in parameter panels)
 *
 * @version $Id$
 * @package JCollection
...
class JElementIsbndbitem extends JElement
{
	/**
	* Element name
	*
	...
	*/
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if($value) {
			...
			$item->name = JText::_('Find ISBNdb id');
		}
		...
		$link = 'index.php?option='._JC_COMPNAME.'&amp;controller=elements&amp;task=isbndbitem&amp;tmpl=component&amp;object='.$name;
