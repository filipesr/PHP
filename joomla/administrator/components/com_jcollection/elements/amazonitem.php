<?php
/**
 * JCollection Amazonitem element (for usage in parameter panels)
 *
 * @version $Id$
 * @package JCollection
...
class JElementAmazonitem extends JElement
{
	/**
	* Element name
	*
	...
	*/
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		$link = 'index.php?option='._JC_COMPNAME.'&amp;controller=elements&amp;task=amazonitem&amp;tmpl=component&amp;object='.$name;
