<?php
/**
 * JCollection Webservicetypes Model class
 *
 * @version $Id$
 * @package JCollection
...
/**
 * Webservicetypes Model
 *
 * @package JCollection
 * @subpackage com_jJcollection
 */
class JCollectionModelWebservicetypes extends JModel
{
	/**
	 * Webservicetypes data array
	 *
	 * @var array
	 */
	var $_data;
	...
	{
		$model = &JModel::getInstance('webservicetype','JCollectionModel');
	...
	function _buildQuery( )
	{
		...
		$query = " SELECT i.* "
		."\n FROM #__"._JC_DB."_webservicetype AS i "
		."\n ".$where
		."\n ".$orderby
		;
		return $query;
