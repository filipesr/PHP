<?php
/**
 * List Category Model for JCollection Component
 *
 * @version $Id$
 * @package JCollection
...
/**
 * JCollection List Category Model
 *
 * @package com_collection
 */
class JCollectionModelListcat extends JModel
{
	/**
	 * The current item id
	 * @var int
	...
	function &getData()
	{
		// Load the data
		if (empty( $this->_data )) {
			$query = " SELECT * FROM #__"._JC_DB."_listcat "
