...
class JCollectionModelRev extends JModel
{
	...
	function &getData()
	{
		// Load the data
		if (empty( $this->_data )) {
			$query = " SELECT e.*,r.rating1,r.rating2,r.rating3,r.rating4,r.rating5,i.name AS infoname,m.name AS itemname,m.id AS itemid, c.name AS catname, "
