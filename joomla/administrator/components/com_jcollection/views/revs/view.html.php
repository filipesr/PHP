<?php
/**
 * JCollection Reviews View class
 *
 * @version $Id$
 * @package JCollection
 ...
 */
class JCollectionViewRevs extends JView
{
	/**
	...
	**/
	function display($tpl = null)
	{
		...
		// build toolbar
		JToolBarHelper::title(   JText::_( 'JCollection - Reviews' ), 'generic.png' );
		...
		$filter_order = $mainframe->getUserStateFromRequest( $option.'.filter_order', 'filter_order', 'r.ordering', 'cmd' );
		...
		$lists['item'] = JCollectionHelper::filterItem( 'filter_item', intval($filter_item) );
