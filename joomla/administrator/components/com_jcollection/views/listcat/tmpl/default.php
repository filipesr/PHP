...
<script language="javascript" type="text/javascript">
                function submitbutton(pressbutton) {
                        ...
                        if ( form.name.value == '' ){
                                alert("<?php echo JText::_( 'List category must have a name', true ); ?>");
                        } else {
                                <?php
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	<tr>
		...
		echo $pane->startPanel( JText::_( 'Parameters - List Category' ), 'params-page' );
...
<input type="hidden" name="option" value="<? echo $option; ?>" /> <input
	...
	name="controller" value="listcat" /> <?php echo JHTML::_( 'form.token' ); ?>
</form>
