...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th width="20"><input type="checkbox" name="toggle" value=""
				onclick="checkAll(<?php echo count( $this->l->items ); ?>);" /></th>
			...
			<?php echo JHTML::_('grid.order',  $this->l->items ); ?></th>
		</tr>
	</thead>
	<tfoot>
		<tr>
	...
	<?php
	$k = 0;
	for ($i=0, $n=count( $this->l->items ); $i < $n; $i++)
	{
		$row = &$this->l->items[$i];
...
<input type="hidden" name="listid" value="<?php echo $this->l->id; ?>" />
<input
