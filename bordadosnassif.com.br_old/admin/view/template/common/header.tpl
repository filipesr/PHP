  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $product; ?>"><?php echo $text_product; ?></a></li>
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$attribute))){ ?>
          <li><a class="parent"><?php echo $text_attribute; ?></a>
            <ul>
			 ...
			 <?php } ?>
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$option))){ ?>
          <li><a href="<?php echo $option; ?>"><?php echo $text_option; ?></a></li>
			 <?php } ?>
          <!--li><a href="<?php echo $manufacturer; ?>"><?php echo $text_manufacturer; ?></a></li-->
          <!--li><a href="<?php echo $download; ?>"><?php echo $text_download; ?></a></li-->
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$review))){ ?>
          <li><a href="<?php echo $review; ?>"><?php echo $text_review; ?></a></li>
			 <?php } ?>
          <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
        </ul>
      </li>
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$module))){ ?>
      <li id="extension"><a class="top"><?php echo $text_extension; ?></a>
        <ul>
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$module))){ ?>
          <li><a href="<?php echo $module; ?>"><?php echo $text_module; ?></a></li>
			 <?php } ?>
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$shipping))){ ?>
          <li><a href="<?php echo $shipping; ?>"><?php echo $text_shipping; ?></a></li>
			 <?php } ?>
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$payment))){ ?>
          <li><a href="<?php echo $payment; ?>"><?php echo $text_payment; ?></a></li>
			 <?php } ?>
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$total))){ ?>
          <li><a href="<?php echo $total; ?>"><?php echo $text_total; ?></a></li>
			 <?php } ?>
			 <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$feed))){ ?>
      ...
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
	   ...
	   <?php if ($this->user->hasPermission('access', $this->url->getURLVar('route',$setting))){ ?>
...
function getURLVar(urlVarName, urlHalves) {
	var urlHalves = String((typeof urlHalves == 'undefined' ? document.location : urlHalves)).toLowerCase().split('?');
	var urlVarValue = '';
