...
<div id="content"><?php echo $content_top; ?>
  ...
  <div id="tabs" class="htabs"><a href="#tab-description"><?php echo $tab_description; ?></a>
    ...
    <?php } else { ?>
    <a href="#tab-review">Comente tamb&eacute;m... (<fb:comments-count href="<?php echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>"></fb:comments-count>)</a>
    <?php } ?>
    <?php if ($products) { ?>
  ...
  <?php } else { ?>
		<div class="box">
		  ...
		  <div class="box-content">
			 <div class="box-product" id="facebook_comments_<?php echo '0'; ?>">
