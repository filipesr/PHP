  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="help"><a class="top"><?php echo $text_help; ?></a>
        <ul>
          <li><a onClick="window.open('http://www.uhoo.com.br');"><?php echo $text_opencart; ?></a></li>
          <li><a onClick="window.open('http://www.uhoo.com.br/documentacao/opencart');"><?php echo $text_documentation; ?></a></li>
          <li><a onClick="window.open('http://uhoo.com.br/aulas/video/opencart');"><?php echo $text_support; ?></a></li>
        </ul>
      </li>
    </ul>
    <ul class="right">
