...
<div class="box">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<table class="form">
			...
			<?php } ?> 
				...
				<tr>
					...
					<td><span class="required">* </span><input type="text" name="tagcloud_limit" value="<?php echo $tagcloud_limit; ?>" size="1" />&nbsp; 20 por exemplo
						<?php if ($error_limit) { ?>
							<div class="error"><?php echo $error_limit; ?></div>
						<?php } ?>	
					</td>
				</tr>
				
				<tr>
					<td><?php echo $entry_min_font_size; ?></td>
					<td><input type="text" name="tagcloud_min_font_size" value="<?php echo $tagcloud_min_font_size; ?>" size="1" />&nbsp; px</td>
				</tr>
				
				<tr>
					<td><?php echo $entry_max_font_size; ?></td>
					<td><input type="text" name="tagcloud_max_font_size" value="<?php echo $tagcloud_max_font_size; ?>" size="1" />&nbsp; px</td>
				</tr>
				
				<tr>
				  <td><?php echo $entry_font_weight; ?></td>
				  <td><select name="tagcloud_font_weight">
					  <?php foreach ($font_weights as $font_weight) { ?>
					  <?php if ($tagcloud_font_weight == $font_weight['font_weight']) { ?>
		...
		<br>
		<div style="text-align:center; color:#555555;">TagCloud v<?php echo $tagcloud_version; ?></div>
</div>
<?php echo $footer; ?>
