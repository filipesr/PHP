...
$lang = array_merge($lang, array( 
	...
	<br />
	Ao clicar abaixo para prosseguir com o registro você concorda em seguir estas condições.<br />
	<br />
	Afirmo que tenho idade igual ou superior a 15 anos, caso seja menor seu cadastro sera excluído sem abivo prévio.', 
...
$lang = array_merge($lang, array( 
	...
	'UPLOAD_AVATAR_FILE'			=> 'Enviar foto do seu computador', 
	...
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Usar somente letras maiúsculas.  Esse será o nome pelo qual será reconhecido no meio dos praticantes de Airsoft. Não será possível muda-lo no futuro, por isso pense bem em qual NG irá usar, antes de informa-lo.', 
