...
window.jQuery || document.write(unescape('%3Cscript src="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>../password_strength/jquery.js" type="text/javascript"%3E%3C/script%3E'));
</script>
<script type="text/javascript" src="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>../password_strength/password_strength_min.js"></script>