...
// ]]>
	...
	<dl> 
		<dt><label for="allowthankspm"><?php echo ((isset($this->_rootref['L_ALLOW_THANKS_PM_ON'])) ? $this->_rootref['L_ALLOW_THANKS_PM_ON'] : ((isset($user->lang['ALLOW_THANKS_PM_ON'])) ? $user->lang['ALLOW_THANKS_PM_ON'] : '{ ALLOW_THANKS_PM_ON }')); ?>:</label></dt>
		<dd><label><input type="radio" class="radio" name="allowthankspm" value="1"<?php if ($this->_rootref['ALLOW_THANKS_PM']) {  ?> id="allowthankspm" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
			<label><input type="radio" class="radio" name="allowthankspm" value="0"<?php if (! $this->_rootref['ALLOW_THANKS_PM']) {  ?> id="allowthankspm" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
	</dl>
	<dl> 
		<dt><label for="allowthanksemail"><?php echo ((isset($this->_rootref['L_ALLOW_THANKS_EMAIL_ON'])) ? $this->_rootref['L_ALLOW_THANKS_EMAIL_ON'] : ((isset($user->lang['ALLOW_THANKS_EMAIL_ON'])) ? $user->lang['ALLOW_THANKS_EMAIL_ON'] : '{ ALLOW_THANKS_EMAIL_ON }')); ?>:</label></dt>
		<dd><label><input type="radio" class="radio" name="allowthanksemail" value="1"<?php if ($this->_rootref['ALLOW_THANKS_EMAIL']) {  ?> id="allowthanksemail" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
			<label><input type="radio" class="radio" name="allowthanksemail" value="0"<?php if (! $this->_rootref['ALLOW_THANKS_EMAIL']) {  ?> id="allowthanksemail" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
	</dl>
	<dl> 
		<dt><label for="allowthankspm"><?php echo ((isset($this->_rootref['L_ALLOW_THANKS_PM_ON'])) ? $this->_rootref['L_ALLOW_THANKS_PM_ON'] : ((isset($user->lang['ALLOW_THANKS_PM_ON'])) ? $user->lang['ALLOW_THANKS_PM_ON'] : '{ ALLOW_THANKS_PM_ON }')); ?>:</label></dt>
		<dd><label><input type="radio" class="radio" name="allowthankspm" value="1"<?php if ($this->_rootref['ALLOW_THANKS_PM']) {  ?> id="allowthankspm" checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
