	...
	<div class="column2">
		...
		<dl class="details">
			...
			<?php if ($this->_rootref['TOTAL_IMAGES']) {  ?>
				...
				<dt><?php echo ((isset($this->_rootref['L_TOTAL_IMAGES'])) ? $this->_rootref['L_TOTAL_IMAGES'] : ((isset($user->lang['TOTAL_IMAGES'])) ? $user->lang['TOTAL_IMAGES'] : '{ TOTAL_IMAGES }')); ?>:</dt>
					<dd><?php echo (isset($this->_rootref['IMAGES'])) ? $this->_rootref['IMAGES'] : ''; ?> | <strong><a href="<?php echo (isset($this->_rootref['U_SEARCH_GALLERY'])) ? $this->_rootref['U_SEARCH_GALLERY'] : ''; ?>"><?php echo ((isset($this->_rootref['L_SEARCH_USER_IMAGES'])) ? $this->_rootref['L_SEARCH_USER_IMAGES'] : ((isset($user->lang['SEARCH_USER_IMAGES'])) ? $user->lang['SEARCH_USER_IMAGES'] : '{ SEARCH_USER_IMAGES }')); ?></a></strong>
						<?php if ($this->_rootref['IMAGES_PCT']) {  ?><br />(<?php echo (isset($this->_rootref['IMAGES_PCT'])) ? $this->_rootref['IMAGES_PCT'] : ''; ?> / <?php echo (isset($this->_rootref['IMAGES_DAY'])) ? $this->_rootref['IMAGES_DAY'] : ''; ?>)<?php } ?>
...
<?php $this->_tpl_include('gallery/recent_body.html'); $this->_tpl_include('jumpbox.html'); $this->_tpl_include('overall_footer.html'); ?>