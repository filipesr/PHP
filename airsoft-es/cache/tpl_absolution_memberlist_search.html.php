...
<div class="panel">
	...
	<dl>
		<dt><label for="family_name"><?php echo ((isset($this->_rootref['L_FAMILY_NAME'])) ? $this->_rootref['L_FAMILY_NAME'] : ((isset($user->lang['FAMILY_NAME'])) ? $user->lang['FAMILY_NAME'] : '{ FAMILY_NAME }')); ?>:</label></dt>
		<dd><input type="text" name="family_name" id="family_name" value="<?php echo (isset($this->_rootref['FAMILY_NAME'])) ? $this->_rootref['FAMILY_NAME'] : ''; ?>" class="inputbox" /></dd>
	</dl>
