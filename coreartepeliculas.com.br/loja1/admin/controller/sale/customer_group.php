...
class ControllerSaleCustomerGroup extends Controller {
	...
	private function getList() {
		...
		$this->data['column_min_order'] = $this->language->get('column_min_order');
	...
	private function getForm() {
		...
		$this->data['entry_min_order'] = $this->language->get('entry_min_order');
		...
		if (isset($this->request->post['min_order'])) {
			$this->data['min_order'] = $this->request->post['min_order'];
		} elseif (!empty($customer_group_info)) {
			$this->data['min_order'] = $customer_group_info['min_order'];
		} else {
			$this->data['min_order'] = '';
		}	
