	<!-- inserido para excluir o modulo -->
	<?php echo $header; 
	  	if ($logged && $this->cart->countProducts() < $this->customer->getCustomerGroupMinOrder()){
	?>
	<div id="content">
	  <div class="breadcrumb">
		 ...
		 <?php } ?>
	  <div class="warning"><?php echo sprintf($this->language->get('error_no_min_order'), $this->cart->countProducts(), $this->customer->getCustomerGroupName(), $this->customer->getCustomerGroupMinOrder()); ?></div>
	  </div>
	<?php echo $footer; ?>
	<?php 
		Exit(); 
