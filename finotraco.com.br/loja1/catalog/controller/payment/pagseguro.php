...
class ControllerPaymentPagseguro extends Controller {
 	protected function index() {
		...
		// Altera a codifica&ccedil;&atilde;o padr&atilde;o da API do PagSeguro (ISO-8859-1)
		...
		// Ajuste no nome do comprador para o m&aacute;ximo de 50 caracteres exigido pela API
		...
		$paymentRequest->setSenderEmail(trim($order_info['email'])); // h&aacute; limita&ccedil;&atilde;o de 60 caracteres de acordo com a API
		
		// OpenCart n&atilde;o separa o DDD do número do telefone. Assim, tentamos separ&aacute;-los, mas somente se o telefone obedecer ao padr&atilde;o de 10 d&iacute;gitos
		...
		if($tipo_frete){
	    	...
	    	$paymentRequest->setShippingType(3); // 3: N&atilde;o especificado
	    }		
	   	...
	   	if ($this->cart->hasShipping()) {
			...
			$paymentRequest->setShippingAddress(  
				Array(  
					...
					'number' 	=> '', // N&atilde;o h&aacute; este campo no OpenCart
					'complement'=> '', // N&atilde;o h&aacute; este campo no OpenCart
		 ...
		 */
 		...
 		foreach ($this->cart->getProducts() as $product) {
			...
			// limite de 100 caracteres para a descri&ccedil;&atilde;o da pel&iacute;cula
			if($mb_substr){
			...
			// O frete ser&aacute; calculado pelo PagSeguro.
			if($tipo_frete){
	    ...
	    // Refer&ecirc;ncia do pedido no PagSeguro
		...
		if ($total > 0) {
	   	 ...
	   	 * Se tiver sucesso, retorna o código (url) de requisi&ccedil;&atilde;o para este pagamento.
	   	 */
		try {
    		...
    		switch($strType) {
				...
				case 'TRANSACTION':
    		    	...
    		    	try {
						...
						// Valor 1: Pac, valor 2: Sedex, valor 3: n&atilde;o especificado ou c&aacute;lculo n&atilde;o realizado pelo PagSeguro
				...
				default:
					$this->log->write('PagSeguro: tipo de notifica&ccedil;&atilde;o desconhecido ['.$notificationType->getValue().']');
			}    		
    	}
    	else{
    		$this->log->write('PagSeguro: Parâmetros de notifica&ccedil;&atilde;o inv&aacute;lidos.');
    	}	
	}
